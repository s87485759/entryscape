...
dojo.provide("hnetfolio.apps.DefaultFolio");
...
dojo.declare("hnetfolio.apps.DefaultFolio", folio.WidgetApplicationAbstract, {
	templatePath: dojo.moduleUrl("hnetfolio.apps", "DefaultFolioTemplate.html"),
