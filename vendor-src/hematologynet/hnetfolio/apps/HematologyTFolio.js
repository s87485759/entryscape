...
dojo.provide("hnetfolio.apps.HematologyTFolio");
...
dojo.declare("hnetfolio.apps.HematologyTFolio", [dijit._Widget, dijit._Templated], {
	templatePath: dojo.moduleUrl("hnetfolio.apps", "HematologyTFolioTemplate.html"),
