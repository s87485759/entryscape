...
dojo.provide("folio.admin.GroupRemove");
...
dojo.declare("folio.admin.GroupRemove", [dijit._Widget, dijit._Templated, folio.admin.TabContent], {
	templatePath: dojo.moduleUrl("folio.admin", "GroupRemoveTemplate.html"),
