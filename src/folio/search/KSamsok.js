...
dojo.provide("folio.search.KSamsok");
dojo.require("dijit._Widget");
dojo.require("dijit._Templated");
dojo.require("dijit.form.TextBox");
dojo.require("dojo.data.ItemFileReadStore");
dojo.require("folio.search.KSamsokList");

/**
 */
dojo.declare("folio.search.KSamsok", [dijit._Widget, dijit._Templated], {
	//===================================================
...
//			sort: this._getSortOrder(),
	...
	_search: function(parameters) {
		...
		entry.list = new folio.search.KSamsokList(entry, parameters);
