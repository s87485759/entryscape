...
dojo.provide("folio.apps.QuickView");
 ...
 * if it is embeddable.  
 */
dojo.declare("folio.apps.QuickView", folio.WidgetApplicationAbstract, {
	//===================================================
	// Inherited Attributes
	//===================================================
	templatePath: dojo.moduleUrl("folio.apps", "QuickViewTemplate.html"),
