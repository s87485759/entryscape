dojo.provide("folio.navigation.FDO");
 ...
 */
dojo.declare("folio.navigation.FDO", null, {
	...
	*/
	...
	_resolveEntry: function(entryStr) {
		if (entryStr === "..") {
			var cind = dojo.indexOf(this.stack, this.current);
			if (cind > 0) {
	...
	_acceptableEntryId: function(id) {
		return (dojo.isString(id) && id.charAt(0) === '_') 
			|| !isNaN(parseInt(id));
	},
