...
define([
    ...
    return declare(null, {
        ...
        constructor: function () {
            ...
            var loadEntry = lang.hitch(this, function (event, params) {
            ...
            array.forEach(arr, function (action) {
                connect.subscribe("/confolio/" + action, lang.hitch(this, function (action, params) {
                    var event = lang.mixin({action: action}, params);
