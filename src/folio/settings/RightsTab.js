...
define(["dojo/_base/declare",
    ...
    return declare([_Widget, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        postCreate: function () {
            ...
            fixBusyButton(this._saveGroupAccessButton);

            this.connect(this._groupInfoGuestChoiceDijit, "onClick", lang.hitch(this, this._groupACLChange, "_guest", "mread"));
            this.connect(this._groupInfoUsersChoiceDijit, "onClick", lang.hitch(this, this._groupACLChange, "_users", "mread"));
            this.connect(this._groupInfoMembersChoiceDijit, "onClick", lang.hitch(this, function() {
                this._groupACLChange(this._group.getId(), "mread");
            }));
            this.connect(this._membersGuestChoiceDijit, "onClick", lang.hitch(this, this._groupACLChange, "_guest", "rread"));
            this.connect(this._membersUsersChoiceDijit, "onClick", lang.hitch(this, this._groupACLChange, "_users", "rread"));
            this.connect(this._membersMembersChoiceDijit, "onClick", lang.hitch(this, function() {
                this._groupACLChange(this._group.getId(), "rread");
            }));
            ...
            this.connect(this._portfolioMembersChoiceDijit, "onClick", lang.hitch(this, function() {
                this._portfolioACLChange(this._group.getId(), "rread");
            }));
        },

        showEntry: function (entry) {
            this._group = entry;
            this._groupACL = folio.data.getACLList(entry);

            //Update editor
            var id = this._group.getId();
            var rights = {mread: {}, rread: {}};
            array.forEach(this._groupACL, function(ac) {
                if (ac.mread) {
            ...
            if (rights.mread["_guest"]) {
                this._groupInfoGuestChoiceDijit.set("checked", true);
            } else if (rights.mread["_users"]) {
                this._groupInfoUsersChoiceDijit.set("checked", true);
            } else if (rights.mread[id]) {
                this._groupInfoMembersChoiceDijit.set("checked", true);
            } else {
                //Set none selected
                this._groupInfoMembersChoiceDijit.set("checked", true);
                this._groupInfoMembersChoiceDijit.set("checked", false);
            }
            ...
            var homeContextUri = this._group.getHomeContext();
        ...
        _setHomeContext: function(homeContext) {
            ...
            } else if (rights.rread[this._group.getId()]) {
                this._portfolioMembersChoiceDijit.set("checked", true);
            } else {
                //Set none selected
                this._portfolioMembersChoiceDijit.set("checked", true);
                this._portfolioMembersChoiceDijit.set("checked", false);
            }
        },

        _groupACLChange: function(principalId, acp) {
            this._groupACL = this._ACLChange(this._groupACL, principalId, acp);
            this._saveGroupAccessButton.set("disabled", false);
        },
        ...
        _saveGroupAccess: function() {
            folio.data.setACLList(this._group, this._groupACL);
            this._group.saveInfo(lang.hitch(this, function() {
                this._saveGroupAccessButton.cancel();
                this._saveGroupAccessButton.set("disabled", true);
        ...
        _saveHomeContext: function() {
            if (this._prospectiveHomeContext != null) {
                this._group.setHomeContext(this._prospectiveHomeContext.getResourceUri());
                this._group.saveInfo(lang.hitch(this, function() {
