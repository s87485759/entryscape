dojo.provide("shame.form.Duration");
dojo.require("dijit.form.NumberSpinner");
dojo.require("dijit.layout.ContentPane");

dojo.declare("shame.form.DurationPresentation", [dijit._Widget, dijit._Templated], {	
	templatePath: dojo.moduleUrl("shame.form", "DurationPresentationTemplate.html"),
...
dojo.declare("shame.form.Duration", shame.form.DurationPresentation, {	
	templatePath: dojo.moduleUrl("shame.form", "DurationTemplate.html"),
	attributeMap: dojo.mixin(dojo.clone(dijit.layout.ContentPane.prototype.attributeMap), {
		yearsLabel: {node: "yearsLabelNode", type: "innerHTML"},
		monthsLabel: {node: "monthsLabelNode", type: "innerHTML"},
		daysLabel: {node: "daysLabelNode", type: "innerHTML"},
