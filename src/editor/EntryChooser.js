...
function(declare, lang, on, aspect, domClass, domConstruct, focusUtil, Chooser, TextBox, SearchList, system) {

    var EntryChooser = declare(Chooser, {
        postCreate: function() {
            this.inherited("postCreate", arguments);
            var search = new TextBox({trim: true, lowercase: true}, domConstruct.create("div", null, this.selectionNode));
